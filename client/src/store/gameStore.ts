...
interface State {
  ...
  createRoom(name: string, opts?: { winningScore?: number; rummyWindowMs?: number; aceHigh?: boolean; simplifiedScoring?: boolean; numDecks?: number; startingHandSize?: number; boathouseRule?: boolean }): Promise<{ roomCode: string; playerId: string }>;
